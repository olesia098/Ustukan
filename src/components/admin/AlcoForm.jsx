...
import { addNewAlco, getAlcoholes } from "../../store/alcohole/alcoActions";
...
const AlcoForm = () => {
  ...
  const handleSubmit = (e) => {
    ...
    dispatch(getAlcoholes())
      .unwrap()
      .then(() => {
        alert("Алкогольный напиток добавлен!");
        setForm({
          id: 0,
          name: "",
          description: "",
      ...
      .catch((error) => {
        alert("Ошибка при добавлении алкогольного напитка: " + error);
      });
  };
